...
export const R_ETH_MAP: Record<Network, Address | undefined> = {
...
export const RS_ETH_MAP: Record<Network, Address | undefined> = {
...
export const S_GLP_MAP: Record<Network, Address | undefined> = {
...
export const USDE_MAP: Record<Network, Address | undefined> = {
  [Network.ARBITRUM_ONE]: undefined,
  [Network.BASE]: undefined,
  [Network.BOTANIX]: undefined,
  [Network.BERACHAIN]: '0x5d3a1Ff2b6BAb83b63cd9AD0787074081a52ef34',
  [Network.ETHEREUM]: '0x4c9EDD5852cd905f086C759E8383e09bff1E68B3',
  [Network.INK]: undefined,
...
export const WE_ETH_MAP: Record<Network, Address | undefined> = {
  ...
  [Network.BASE]: undefined,
  [Network.BERACHAIN]: '0x7DCC39B4d1C53CB31e1aBc0e358b43987FEF80f7',
  [Network.BOTANIX]: undefined,
  [Network.ETHEREUM]: '0xCd5fE23C85820F7B72D0926FC9b05b43E359b7ee',
  [Network.INK]: undefined,
  [Network.MANTLE]: undefined,
  [Network.POLYGON_ZKEVM]: undefined,
  [Network.X_LAYER]: undefined,
...
export const WST_ETH_MAP: Record<Network, Address | undefined> = {
  [Network.ARBITRUM_ONE]: '0x5979D7b546E38E414F7E9822514be443A4800529',
  [Network.BASE]: undefined,
  [Network.BERACHAIN]: undefined,
  [Network.BOTANIX]: undefined,
  [Network.ETHEREUM]: '0x7f39C581F595B53c5cb19bD0b3f8dA6c935E2Ca0',
  [Network.INK]: undefined,
  [Network.MANTLE]: undefined,
  [Network.POLYGON_ZKEVM]: undefined,
  [Network.X_LAYER]: undefined,
